...
versions = ['orig', 'v01x', '1d-ow', 'v021x', '1d-ad', 'v022x', '2d-ad', 'v023x', '2d-ad-t', 'v024x', '2d-ad-f', 'v025x',\
            '2d-ad-ft', 'v026x', '2d-lz', 'v027x']
...
if args.version == ['orig'] or args.version == ['v01x']:
    v_data_access = ".data_access_v01x_orig"
elif args.version == ['1d-ow'] or args.version == ['v021x']:
